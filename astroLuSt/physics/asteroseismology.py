...
class ScalingRelations:
    """
        - class to apply the asteroseismic scaling relations
            - i.e. [Gaulme et al., (2016)](https://ui.adsabs.harvard.edu/abs/2016ApJ...832..121G/abstract) and reference therein
    ...
    def get_radius(self) -> Tuple[np.ndarray,np.ndarray]:
        """
            ...
            -------
                ...
                - `self.e_radius_seism`
                    - `np.ndarray`
                    - error estimate corresponding to `self.radius_seism`
            Comments
            --------            
    ...
    def get_mass(self) -> Tuple[np.ndarray,np.ndarray]:
        """
            ...
            -------
                ...
                - `self.e_mass_seism`
                    - `np.ndarray`
                    - error estimate corresponding to `self.mass_seism`
    ...
    def get_logg(self) -> Tuple[np.ndarray,np.ndarray]:
        """
            ...
            -------
                ...
                - `self.e_logg_seism`
                    - `np.ndarray`
                    - error estimate corresponding to `self.logg_seism`
    ...
    def get_luminosity(self) -> Tuple[np.ndarray,np.ndarray]:
        """
